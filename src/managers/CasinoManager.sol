...
contract CasinoCounter is Ownable {
    ...
    function addTotalBets(address _player, uint256 _gameType) public onlyOwner {
        totalBets[_player][_gameType]++;
    }

    function addTotalRewards(address _player, uint256 _gameType) public onlyOwner {
        totalRewards[_player][_gameType]++;
    }
